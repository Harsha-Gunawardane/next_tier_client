  ...
  const fetchStudyPackContent = async (studyPackId) => {
    ...
    try {
      const response = await axiosPrivate.get(
        `/stu/studypacks/${studyPackId}/content`,
        {
        ...
        </HStack>
        {
          ...
          contentIDs.video_id.length > 0 ? (
            ...
            >
              ...
              <Text noOfLines={1} fontSize={"0.9rem"}>
                No Video Content Added
              </Text>
            </Flex>
          )
        }
                ...
                return (
                  ...
                  >
                    <Flex gap={2} alignItems={"center"}>
                      ...
                      <Text fontSize="14px">{content[tuteId].title}</Text>
                    </Flex>
                ...
                return (
                  ...
                  >
                    <Flex gap={2} alignItems={"center"}>
                      ...
                      <Text fontSize="14px">{content[quizId].title}</Text>
                    </Flex>
