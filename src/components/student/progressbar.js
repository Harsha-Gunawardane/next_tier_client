...
<HStack spacing='24px'>
  <Box w='20%' h='30px' bg='white'>
    <Heading fontSize='18px'>#Quiz 23</Heading>
    <Text fontSize='12px'>23rd June 2023</Text>
  </Box>
  <Box w='65%' h='30px' bg='white' mt='20px'>
  <Progress width='100%' value={80} mt='10px' height='10px'/>
  </Box>
