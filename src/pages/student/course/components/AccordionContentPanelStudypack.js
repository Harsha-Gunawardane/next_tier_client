...
const AccordionContentPanelStudypack = (props) => {

    const { studyPackId, contentIDs, isOpen, enrolled, purchased } = props;
    const [content, setContent] = useState({});
    const [isContentLoading, setIsContentLoading] = useState(true);
    const axiosPrivate = useAxiosPrivate();

    useEffect(() => {
        if (isOpen && isContentLoading) {
...
export default AccordionContentPanelStudypack
