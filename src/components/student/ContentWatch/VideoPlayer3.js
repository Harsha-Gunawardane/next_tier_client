...
class VideoPlayer3 extends React.PureComponent {
    ...
    componentDidMount() {
        ...
        var manifestUri = 'https://storage.googleapis.com/hls-streaming-gcp-processed-files-fluted-clock-395620/video1235773885.mp4/manifest.mpd';
