...
{studypackdata &&
  ...
  <Box w='50%' h='30px' bg='white'>
  <Text ml='35px' fontSize='15px'>Rs.{studypackdata.price}</Text>
  </Box>
  <Box w='50%' h='30px' bg='white'>
  <Text ml='35px' fontSize='15px'>Sinhala</Text>
  </Box>
          ...
          <Text fontSize={{base:13,xl:15}}>{studypackdata.description}</Text>
          </Box>
        ...
        <Box width="80%" ml="10%" bg="white " mt={{base:-20,xl:0}} p={10} borderRadius="10px">
