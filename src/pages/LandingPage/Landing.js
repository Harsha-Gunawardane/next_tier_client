    ...
    <div>
      ...
      <section id="about">
        <div className="about-text">
          <h1 className="about-text-title1">Your Ultimate <span className="about-text-span">All-In-One</span> Education Platform</h1>
          <p> Experience the power of NextTier is  a comprehensive cloud software suite designed to revolutionize your learning journey.
            Seamlessly integrate courses, teachers, students, and administrative tasks in one centralized platform. Discover the future of education
            with NextTier.</p>
        ...
        <div className="cards">
          ...
          <div className="card-items">
            <div className="card-img"><img className="card1-img" src={card1_img} alt="" /></div>
            <div className="card-text-title">Personalized Student</div>
            <div className="card-text-title">Tracking </div>
            <div className="card-text-des1">Effortlessly track student progress, attendance, and performance with NextTier.
              Gain valuable insights, personalize learning paths, and empower student success.</div>
          </div>

          <div className="card-items">
            <div className="card-img"><img className="card1-img" src={card2_img} alt="" /></div>
            <div className="card-text-title">Student Community </div>

            <div className="card-text-des2">Collaborate, share ideas, and learn from peers on NextTier.
              Connect with students across disciplines, engage in discussions, and create a supportive learning environment.</div>
          </div>

          <div className="card-items">
            <div className="card-img"><img className="card1-img" src={card3_img} alt="" /></div>
            <div className="card-text-title">Courses,Study Pack,
            </div>
            <div className="card-text-title">Quizzes & Tests </div>
            <div className="card-text-des3">Access a vast library of educational resources on NextTier.
              Dive into interactive courses, study packs, and quizzes to enhance your learning experience and test your knowledge..</div>
          </div>

          <div className="card-items">
            <div className="card-img"><img className="card1-img" src={card4_img} alt="" /></div>
            <div className="card-text-title">Parental
              Engagement </div>
            <div className="card-text-des4">Stay involved and connected with your child's educational journey.
              Access real-time updates on their progress, attendance, and performance.</div>
          </div>
        ...
        <div className="more_des">
          <div className="more_des_text">
            <h1 className="more_des_text_title">What is <span className="more_des_title_span">NextTier?</span></h1>
            <p>Since its establishment in 2002, NextTier has been dedicated to transforming the education landscape in Sri Lanka.
              Today, we are proud to introduce our state-of-the-art online platform tailored specifically for educational institute
              in Nugegoda, Colombo. Our comprehensive platform empowers institutions to streamline operation and  enhance student engagement.
              With NextTier,Join us in embracing the digital era and unlocking new possibilities in education. Let's embark on a journey of
              academic excellence together with NextTier</p>
          </div>
          <div className="more_des_img"><img className='tuition_img' src={tuition_img} alt="" /></div>
        </div>

        <div className="get_started">
          <div className="getstarted_image_stu">
            <p> FOR STUDENTS</p>
            <button><Link to="/register" className="join">Get Started</Link></button>
          </div>
      ...
      <div className="feature1">
        ...
        <div className="feature_text">
          ...
          <div className="text">
            <div className="image" style={{ 'margin-top': '60px' }}><img src={point1} alt="" /></div><p className="feature_text_point1">Students can look up courses and teachers,  enroll in courses offered by teachers.</p>

          </div>
          <div className="text">
            <div className="image"><img src={point2} alt="" /></div><p className="feature_text_point2">Students can access their grades and results for the enrolled courses.</p>

          </div>
          <div className="text">
            <div className="image"><img src={point1} alt="" /></div><p className="feature_text_point3">Students can access analytics related to their progress and performance.</p>
      ...
      <div className="feature1">
        <div className="feature_text">
          <h1 className="first_feature_title" style={{ 'margin-left': '180px' }}>Suggest Recommended Content</h1>
          <div className="text">
            <p className="feature_text_point1" style={{ 'margin-left': '180px', 'margin-right': '60px' }}>Based on each student's unique needs and areas of weakness, the system suggests topics. The tutor or his assisting staff can add each student's grades and areas of weakness. Therefore, when the system pinpoints the student's weak regions, the system suggests content focusing on those areas.
