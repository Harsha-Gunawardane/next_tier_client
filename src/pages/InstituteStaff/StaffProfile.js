        ...
        >
          ...
          >
            <Avatar
              ...
              height={200}
              mt={4}
              src={staffDetails.profile_picture}
            ></Avatar>
            ...
            <Text fontSize="small" mt={1}>
              Joined Date:{" "}
              {new Date(staffDetails.join_date).toLocaleDateString()}{" "}
            </Text>
            {/* <Flex mt={3} >
              ...
              <Box borderRadius={15} p={5}>
                ...
                <SimpleGrid columns={2} spacingX={4} spacingY={2}>
                  ...
                  <FormControl>
                    ...
                    <Input bg="white" value="Staff" fontSize="small" readOnly />
                  </FormControl>
                  <FormControl>
                    <FormLabel fontSize="small" mt={3}>
                      Address
            ...
            <Box display="flex" flexDirection="column" alignItems="flex-end">
              <Box>
                <Link to="/staff/staff-list">
                  <Button colorScheme="blue" mr={10} p={3}>
                    Back
                  </Button>
                </Link>
              </Box>
