...
{coursedata &&
  ...
  {coursedata.schedule && coursedata.schedule.length > 0 ? (
                <Text color="black" fontSize="12px" mt="-0px">
                  <TimeIcon /> {coursedata.schedule[0].start_time} - {coursedata.schedule[0].end_time}
                </Text>
                    ) : (
                      <Text color="black" fontSize="12px" mt="-0px">
  ...
  <Box w='50%' h='30px' bg='white'>
  <Text ml='35px' fontSize='12px'>Rs.{coursedata.monthly_fee}</Text>
  </Box>
  <Box w='50%' h='30px' bg='white'>
  <Text ml='35px' fontSize='12px'>{coursedata.medium}</Text>
  </Box>
          ...
          <br></br>
          <Box width='90%'> <Text fontSize='15px'>{coursedata.description}</Text></Box>
