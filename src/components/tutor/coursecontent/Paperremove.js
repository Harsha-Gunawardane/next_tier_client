...
const Paperremove = (props) => {
  ...
  return (
    <>
      <Button colorScheme='red' onClick={onOpen} height='5px' fontSize='10px' width='5px' p={2}>
        -
      </Button>
        ...
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody fontSize='15px'>
              Are you sure You want to remove this paper? You can't undo this action afterwards.
            </AlertDialogBody>
